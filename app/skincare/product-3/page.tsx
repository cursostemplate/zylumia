...
const productImages = [
  "https://ae-pic-a1.aliexpress-media.com/kf/Seaecc79b22174f5b9ddd62e67c74472a5.jpg_960x960q75.jpg_.avif",
...
const offers = [
  {
    id: 301,
    quantity: "1 Brightening Mask",
    supply: "5 Sheet Masks",
    save: "20%",
    price: "£19.95",
    originalPrice: "£24.95",
    ...
    isPopular: false,
    freeGift: false,
    priceId: "price_mask_1",
  },
  {
    id: 302,
    quantity: "2 Brightening Masks",
    supply: "10 Sheet Masks",
    save: "35%",
    price: "£32.95",
    originalPrice: "£49.90",
    image: "https://ae-pic-a1.aliexpress-media.com/kf/Seaecc79b22174f5b9ddd62e67c74472a5.jpg_960x960q75.jpg_.avif",
    isPopular: true,
    freeGift: false,
    priceId: "price_mask_2",
  },
  {
    id: 303,
    quantity: "3 Brightening Masks",
    supply: "15 Sheet Masks",
    save: "45%",
    price: "£41.95",
    originalPrice: "£74.85",
    image: "https://ae-pic-a1.aliexpress-media.com/kf/Seaecc79b22174f5b9ddd62e67c74472a5.jpg_960x960q75.jpg_.avif",
    isPopular: false,
    freeGift: true,
    priceId: "price_mask_3",
  },
]

export default function Product3Page() {
  const [currentImageIndex, setCurrentImageIndex] = useState(0)
  const [selectedOfferId, setSelectedOfferId] = useState(302)
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
              ...
              <div className="relative">
                <div className="aspect-square bg-white rounded-lg overflow-hidden">
                  <NextImage
                    ...
                    alt="Vitamin C Brightening Mask"
                    width={500}
                    height={500}
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-3xl font-bold font-lora text-brand">Vitamin C Brightening Mask</h1>
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <span className="text-sm text-muted-foreground">4.9/5 (3,120+ reviews)</span>
                </div>
              </div>
              ...
              <div className="p-4 bg-pink-100 text-brand rounded-lg text-center">
                <p className="font-semibold">Vitamin C Boost - Glow Guaranteed!</p>
              </div>
